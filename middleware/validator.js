...
exports.validateSignUp = [body('username', 'Username cannot be empty').notEmpty().trim().escape(),
...
body('password', undefined).notEmpty().withMessage('Password cannot be empty').isLength({min: 8, max: 64}).withMessage('Password must be at least 8 characters and at most 64 characters').trim()];
